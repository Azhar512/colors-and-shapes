...
const translations: Translations = {
  ...
  "services.ac.split": { en: "Split AC Installation & Maintenance", ar: "تركيب وصيانة مكيف سبليت" },
  "services.ac.split.desc": { en: "Expert installation of split units with precision piping and regular seasonal maintenance.", ar: "تركيب خبير لوحدات السبليت مع تمديد دقيق للمواسير وصيانة دورية موسمية." },
  "services.ac.window": { en: "Window AC Installation & Maintenance", ar: "تركيب وصيانة مكيف شباك" },
  "services.ac.window.desc": { en: "Secure window unit mounting, sealing, and comprehensive cleaning for optimal airflow.", ar: "تركيب آمن لوحدات الشباك، عزل تام، وتنظيف شامل لتدفق هواء مثالي." },
  "services.ac.wall": { en: "Wall-mounted AC Installation & Maintenance", ar: "تركيب وصيانة مكيف جداري" },
  "services.ac.wall.desc": { en: "Professional wall mounting for various AC types, ensuring stable and aesthetic placement.", ar: "تركيب جداري احترافي لمختلف أنواع المكيفات، مع ضمان ثبات ومظهر جمالي." },
  "services.ac.cassette": { en: "Cassette AC Installation & Maintenance", ar: "تركيب وصيانة مكيف كاسيت" },
  "services.ac.cassette.desc": { en: "Specialized ceiling cassette installation for offices and large halls with balanced cooling.", ar: "تركيب مكيفات كاسيت سقفية متخصصة للمكاتب والصالات الكبيرة مع تبريد متوازن." },
  "services.ac.duct": { en: "Duct Split AC Installation & Maintenance", ar: "تركيب وصيانة مكيف دكت سبليت" },
  "services.ac.duct.desc": { en: "Centralized duct system installation and maintenance for consistent whole-home cooling.", ar: "تركيب وصيانة أنظمة الدكت المركزية لتبريد متسق لكامل المنزل." },
  "services.ac.pipe": { en: "Establishment of Copper Pipe and Duct", ar: "تأسيس مواسير النحاس والدكت" },
  "services.ac.pipe.desc": { en: "Professional pre-installation piping and ductwork for new buildings and renovations.", ar: "تأسيس احترافي للمواسير النحاسية وأعمال الدكت للمباني الجديدة والترميم." },
  "services.ac.package": { en: "Package AC Installation & Maintenance", ar: "تركيب وصيانة مكيفات باكج" },
  "services.ac.package.desc": { en: "Full-service installation and maintenance for large-scale package AC units.", ar: "خدمة متكاملة لتركيب وصيانة وحدات التكييف المركزي (باكج) الكبيرة." },
  "services.buying.old": { en: "Old AC Buyer", ar: "شراء مكيفات قديمة" },
